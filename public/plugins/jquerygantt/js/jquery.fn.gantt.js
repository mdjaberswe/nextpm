    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
                ...
                dataPanel.click(function (e) {
                    ...
                    */
                    ...
                    if(col != null)
                    {
                        ...
                        var rowId = typeof row.data('id') !== 'undefined' ? row.data('id') : 'header';
                    }
                    else
                    {
                        var dt = moment().unix() * 1000;
                        var rowId = 'invalid';
                    }
            ...
            navigateTo: function (element, val) {
                ...
                switch (val) {
                case "begin":
                    $dataPanel.animate({ "left": "0" }, 100, shift);
                ...
                case "end":
                    ...
                    $dataPanel.animate({ "left": "-" + pLeft }, 100, shift);
                    break;
                case "now":
                    ...
                    $dataPanel.animate({ "left": val }, 100, shift);
