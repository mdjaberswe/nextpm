    ...
    <div class="form-group mb0-imp">
        <div class="col-xs-12">
            ...
            <table id="modal-datatable" class="table modal-table responsive" cellspacing="0" width="100%" data-item="import" data-url="import-data"
                   data-column='{{ DataTable::jsonColumn(['name', 'due_date', 'status', 'severity', 'related_to', 'owner', 'error']) }}'
                   data-btn='{{ DataTable::showhideColumn(['checkbox' => false, 'action' => false, 'thead' => ['issue', 'due date', 'status', 'severity', 'related to', 'owner', 'errors / warnings']]) }}'>
                <thead>
                    <tr>
                        <th data-priority="1" data-class-name="all column-dropdown">Issue Name</th>
